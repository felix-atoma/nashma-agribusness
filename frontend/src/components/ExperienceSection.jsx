...
import { FaPhoneAlt, FaSeedling, FaHistory, FaUsers, FaArrowRight } from "react-icons/fa";
      ...
      <section className="relative flex flex-col lg:flex-row items-center gap-12 px-4 md:px-8 py-16 md:py-24 bg-gradient-to-br from-green-50 via-amber-50 to-white overflow-hidden">
        ...
        <div className="relative w-full lg:w-1/2 text-center lg:text-left">
          ...
          <div className="space-y-4 mb-8">
            {[
              "Pioneers in organic cocoa potash production",
              "Authentic African Black Soap — made with our own potash",
              "Training women & youth in potash and soap making",
              "Sustainable farming solutions for Ghanaian communities",
            ].map((point, i) => (
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            ...
            <button
              ...
              className="group flex items-center justify-center gap-3 px-8 py-4 border-2 border-green-600 text-green-700 text-lg font-semibold rounded-xl hover:bg-green-600 hover:text-white transition-all duration-300 transform hover:-translate-y-1 min-w-[180px]"
            >
