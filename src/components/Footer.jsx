            ...
            <div className="grid grid-cols-2 gap-2">
              {quickLinks.map((link, index) => (
                <a
                  key={index}
                  href={link.href}
                  className="text-green-200 hover:text-amber-300 transition-colors duration-300 py-2 text-sm hover:translate-x-1 transform transition-transform"
                >
                  {link.name}
                </a>
              ))}
