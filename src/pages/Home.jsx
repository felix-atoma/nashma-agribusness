...
import { FaArrowUp, FaLeaf, FaSeedling, FaRecycle, FaSpider } from "react-icons/fa";
...
const slides = [
  ...
  },
  {
    ...
    icon: <FaLeaf className="text-4xl mb-4 text-emerald-500" />
  },
];
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white p-4 sm:p-6 z-20">
              ...
              <div className="flex gap-4 mt-6">
                ...
                <button className="border-2 border-white text-white hover:bg-white hover:text-green-800 px-8 py-3 rounded-lg font-semibold transition-all duration-300">
                  Contact Us
                </button>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto space-y-20">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-green-900 mb-6">
              Growing <span className="text-amber-600">Sustainability</span> in Ghana
            </h2>
            <div className="w-24 h-1 bg-amber-500 mx-auto mb-8"></div>
            <p className="text-lg text-green-800 leading-relaxed">
              At Nashma Agribusiness, we are committed to revolutionizing agriculture in Ghana through 
              sustainable practices, innovative solutions, and community empowerment. Our focus on 
              cocoa potash production and organic farming creates a greener future for all.
            </p>
          </div>
