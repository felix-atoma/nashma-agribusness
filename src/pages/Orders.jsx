  ...
  const handleCancelOrder = async (orderId) => {
    if (window.confirm('Are you sure you want to cancel this order? This action cannot be undone.')) {
      try {
        ...
        // The context will handle the state update and toast notifications
      } catch (error) {
              ...
              <div className="space-y-4">
                ...
                <div className="text-sm text-gray-500">
                  ...
                  <div className="flex flex-wrap justify-center gap-2">
                    <a href="/products?category=electronics" className="text-green-600 hover:underline">Electronics</a>
                    <span>•</span>
                    <a href="/products?category=clothing" className="text-green-600 hover:underline">Clothing</a>
                    <span>•</span>
                    <a href="/products?category=home" className="text-green-600 hover:underline">Home & Garden</a>
                    <span>•</span>
                    <a href="/products?category=beauty" className="text--600 hover:underline">Beauty</a>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    {isExpanded && (
                      <div className="p-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          {hasShippingInfo && (
                            <div>
                              <h3 className="text-lg font-semibold text-green-800 mb-4">Shipping Information</h3>
                        ...
                        <div className="mt-6">
                          <h3 className="text-lg font-semibold text-green-800 mb-4">Order Status & Tracking</h3>
                                ...
                                <div key={step.status} className="relative flex items-center mb-6 last:mb-0">
                                  <div className={`w-8 h-8 rounded-full flex items-center justify-center z-10 ${
                                    ...
                                    {step.completed ? (
                                      ...
                                      <div className={`w-3 h-3 rounded-full ${step.current ? 'bg-green-500' : 'bg-green-400'}`}></div>
                                    )}
                                  </div>
                                  <div className="ml-4 flex-1">
                                    <p className={`font-medium capitalize ${step.completed ? 'text-green-700' : 'text-green-400'}`}>
                                    ...
                                    <div className="flex items-center space-x-3">
                                      {itemImage && !hasImageFailed ? (
                                        ...
                                        <div className="w-12 h-12 bg-green-200 rounded flex items-center justify-center">
                                          <span className="text-xs text-green-500">No Image</span>
                                        </div>
                                      )}
                                      <div>
                                        <h4 className="font-medium text-green-800">{itemName}</h4>
                                        <p className="text-sm text-green-600">Quantity: {itemQuantity}</p>
                                      </div>
                                    </div>
                                    <div className="text-right">
                                      <p className="font-medium">${itemPrice.toFixed(2)} each</p>
                                      <p className="text-sm text-green-600">Total: ${itemTotal.toFixed(2)}</p>
                                    </div>
                                  </div>
                                );
                              })
                        ...
                        <div className="mt-6 pt-4 border-t border-gray-200">
                          <div className="flex flex-wrap gap-3">
                            ...
                            <button className="flex items-center border border-gray-300 text-green-700 px-4 py-2 rounded-lg text-sm hover:bg-gray-50">
                        ...
                        <div className="mt-6 bg-blue-50 p-4 rounded-lg">
                          <h4 className="font-medium text-green-800 mb-3">Need help with this order?</h4>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="flex items-center">
                              <Phone className="w-5 h-5 text-green-600 mr-2" />
                              <div>
                                <p className="text-sm font-medium">Call Support</p>
                                <p className="text-sm text-green-700">(+233) 0545086577</p>
                              </div>
                            </div>
                            <div className="flex items-center">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-green-700">nashmafarms@gmail.com</p>
                              </div>
                            </div>
                          </div>
                        </div>
